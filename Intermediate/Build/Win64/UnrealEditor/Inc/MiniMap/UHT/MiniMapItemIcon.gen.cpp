...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UDelegateFunction_MiniMap_MiniMapItemDestroyedSignature__DelegateSignature_Statics::NewProp_MiniMapItemIcon = { "MiniMapItemIcon", nullptr, (EPropertyFlags)0x0010000000080080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(_Script_MiniMap_eventMiniMapItemDestroyedSignature_Parms, MiniMapItemIcon), Z_Construct_UClass_UMiniMapItemIcon_NoRegister, METADATA_PARAMS(Z_Construct_UDelegateFunction_MiniMap_MiniMapItemDestroyedSignature__DelegateSignature_Statics::NewProp_MiniMapItemIcon_MetaData, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_MiniMap_MiniMapItemDestroyedSignature__DelegateSignature_Statics::NewProp_MiniMapItemIcon_MetaData)) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_MiniMap_MiniMapItemDestroyedSignature__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_MiniMap, nullptr, "MiniMapItemDestroyedSignature__DelegateSignature", nullptr, nullptr, sizeof(Z_Construct_UDelegateFunction_MiniMap_MiniMapItemDestroyedSignature__DelegateSignature_Statics::_Script_MiniMap_eventMiniMapItemDestroyedSignature_Parms), Z_Construct_UDelegateFunction_MiniMap_MiniMapItemDestroyedSignature__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_MiniMap_MiniMapItemDestroyedSignature__DelegateSignature_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(Z_Construct_UDelegateFunction_MiniMap_MiniMapItemDestroyedSignature__DelegateSignature_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_MiniMap_MiniMapItemDestroyedSignature__DelegateSignature_Statics::Function_MetaDataParams)) };
...
void FMiniMapItemDestroyedSignature_DelegateWrapper(const FMulticastScriptDelegate& MiniMapItemDestroyedSignature, UMiniMapItemIcon* MiniMapItemIcon)
{
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UMiniMapItemIcon_Statics::NewProp_OnMiniMapItemDestroyed = { "OnMiniMapItemDestroyed", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UMiniMapItemIcon, OnMiniMapItemDestroyed), Z_Construct_UDelegateFunction_MiniMap_MiniMapItemDestroyedSignature__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_UMiniMapItemIcon_Statics::NewProp_OnMiniMapItemDestroyed_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMiniMapItemIcon_Statics::NewProp_OnMiniMapItemDestroyed_MetaData)) }; // 3744048922
	...
	struct Z_CompiledInDeferFile_FID_ContentExamples52_Plugins_UnrealSwissKnife_Source_MiniMap_Public_MiniMapItemIcon_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ContentExamples52_Plugins_UnrealSwissKnife_Source_MiniMap_Public_MiniMapItemIcon_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMiniMapItemIcon, UMiniMapItemIcon::StaticClass, TEXT("UMiniMapItemIcon"), &Z_Registration_Info_UClass_UMiniMapItemIcon, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMiniMapItemIcon), 68234243U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ContentExamples52_Plugins_UnrealSwissKnife_Source_MiniMap_Public_MiniMapItemIcon_h_720808662(TEXT("/Script/MiniMap"),
		Z_CompiledInDeferFile_FID_ContentExamples52_Plugins_UnrealSwissKnife_Source_MiniMap_Public_MiniMapItemIcon_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_ContentExamples52_Plugins_UnrealSwissKnife_Source_MiniMap_Public_MiniMapItemIcon_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
