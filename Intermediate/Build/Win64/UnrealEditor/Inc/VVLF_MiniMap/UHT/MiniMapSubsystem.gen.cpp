...
#include "VVLF_MiniMap/Public/MiniMapSubsystem.h"
...
// Cross Module References
	...
	VVLF_MINIMAP_API UClass* Z_Construct_UClass_UMiniMapItemIcon_NoRegister();
	VVLF_MINIMAP_API UClass* Z_Construct_UClass_UMiniMapSubsystem();
	VVLF_MINIMAP_API UClass* Z_Construct_UClass_UMiniMapSubsystem_NoRegister();
...
// End Cross Module References
	struct Z_Construct_UDelegateFunction_VVLF_MiniMap_MiniMapItemRegisteredSignature__DelegateSignature_Statics
	{
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_VVLF_MiniMap_MiniMapItemRegisteredSignature__DelegateSignature_Statics::NewProp_MiniMapItemIcon_MetaData[] = {
		{ "EditInline", "true" },
	};
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UDelegateFunction_VVLF_MiniMap_MiniMapItemRegisteredSignature__DelegateSignature_Statics::NewProp_MiniMapItemIcon = { "MiniMapItemIcon", nullptr, (EPropertyFlags)0x0010000000080080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(_Script_VVLF_MiniMap_eventMiniMapItemRegisteredSignature_Parms, MiniMapItemIcon), Z_Construct_UClass_UMiniMapItemIcon_NoRegister, METADATA_PARAMS(Z_Construct_UDelegateFunction_VVLF_MiniMap_MiniMapItemRegisteredSignature__DelegateSignature_Statics::NewProp_MiniMapItemIcon_MetaData, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_VVLF_MiniMap_MiniMapItemRegisteredSignature__DelegateSignature_Statics::NewProp_MiniMapItemIcon_MetaData)) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_VVLF_MiniMap_MiniMapItemRegisteredSignature__DelegateSignature_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_VVLF_MiniMap_MiniMapItemRegisteredSignature__DelegateSignature_Statics::NewProp_MiniMapItemIcon,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_VVLF_MiniMap_MiniMapItemRegisteredSignature__DelegateSignature_Statics::Function_MetaDataParams[] = {
		{ "Comment", "/**\n * \n */" },
		{ "ModuleRelativePath", "Public/MiniMapSubsystem.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_VVLF_MiniMap_MiniMapItemRegisteredSignature__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_VVLF_MiniMap, nullptr, "MiniMapItemRegisteredSignature__DelegateSignature", nullptr, nullptr, sizeof(Z_Construct_UDelegateFunction_VVLF_MiniMap_MiniMapItemRegisteredSignature__DelegateSignature_Statics::_Script_VVLF_MiniMap_eventMiniMapItemRegisteredSignature_Parms), Z_Construct_UDelegateFunction_VVLF_MiniMap_MiniMapItemRegisteredSignature__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_VVLF_MiniMap_MiniMapItemRegisteredSignature__DelegateSignature_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(Z_Construct_UDelegateFunction_VVLF_MiniMap_MiniMapItemRegisteredSignature__DelegateSignature_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_VVLF_MiniMap_MiniMapItemRegisteredSignature__DelegateSignature_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UDelegateFunction_VVLF_MiniMap_MiniMapItemRegisteredSignature__DelegateSignature()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UDelegateFunction_VVLF_MiniMap_MiniMapItemRegisteredSignature__DelegateSignature_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UDelegateFunction_VVLF_MiniMap_MiniMapItemUnregisteredSignature__DelegateSignature_Statics
	{
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_VVLF_MiniMap_MiniMapItemUnregisteredSignature__DelegateSignature_Statics::NewProp_MiniMapItemIcon_MetaData[] = {
		{ "EditInline", "true" },
	};
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UDelegateFunction_VVLF_MiniMap_MiniMapItemUnregisteredSignature__DelegateSignature_Statics::NewProp_MiniMapItemIcon = { "MiniMapItemIcon", nullptr, (EPropertyFlags)0x0010000000080080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(_Script_VVLF_MiniMap_eventMiniMapItemUnregisteredSignature_Parms, MiniMapItemIcon), Z_Construct_UClass_UMiniMapItemIcon_NoRegister, METADATA_PARAMS(Z_Construct_UDelegateFunction_VVLF_MiniMap_MiniMapItemUnregisteredSignature__DelegateSignature_Statics::NewProp_MiniMapItemIcon_MetaData, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_VVLF_MiniMap_MiniMapItemUnregisteredSignature__DelegateSignature_Statics::NewProp_MiniMapItemIcon_MetaData)) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_VVLF_MiniMap_MiniMapItemUnregisteredSignature__DelegateSignature_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_VVLF_MiniMap_MiniMapItemUnregisteredSignature__DelegateSignature_Statics::NewProp_MiniMapItemIcon,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_VVLF_MiniMap_MiniMapItemUnregisteredSignature__DelegateSignature_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/MiniMapSubsystem.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_VVLF_MiniMap_MiniMapItemUnregisteredSignature__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_VVLF_MiniMap, nullptr, "MiniMapItemUnregisteredSignature__DelegateSignature", nullptr, nullptr, sizeof(Z_Construct_UDelegateFunction_VVLF_MiniMap_MiniMapItemUnregisteredSignature__DelegateSignature_Statics::_Script_VVLF_MiniMap_eventMiniMapItemUnregisteredSignature_Parms), Z_Construct_UDelegateFunction_VVLF_MiniMap_MiniMapItemUnregisteredSignature__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_VVLF_MiniMap_MiniMapItemUnregisteredSignature__DelegateSignature_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(Z_Construct_UDelegateFunction_VVLF_MiniMap_MiniMapItemUnregisteredSignature__DelegateSignature_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_VVLF_MiniMap_MiniMapItemUnregisteredSignature__DelegateSignature_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UDelegateFunction_VVLF_MiniMap_MiniMapItemUnregisteredSignature__DelegateSignature()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UDelegateFunction_VVLF_MiniMap_MiniMapItemUnregisteredSignature__DelegateSignature_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	DEFINE_FUNCTION(UMiniMapSubsystem::execGetMiniMapBaseArr)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		*(TArray<AVVLF_MiniMapBase*>*)Z_Param__Result=P_THIS->GetMiniMapBaseArr();
		P_NATIVE_END;
	}
	...
	struct Z_Construct_UFunction_UMiniMapSubsystem_GetMiniMapBaseArr_Statics
	{
		...
		{
			TArray<AVVLF_MiniMapBase*> ReturnValue;
		};
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMiniMapSubsystem_GetMiniMapBaseArr_Statics::NewProp_ReturnValue_Inner = { "ReturnValue", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 0, Z_Construct_UClass_AVVLF_MiniMapBase_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UMiniMapSubsystem_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UMiniMapSubsystem_GetMiniMapBaseArr, "GetMiniMapBaseArr" }, // 4054496920
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UMiniMapSubsystem_Statics::NewProp_MiniMapBaseArr_Inner = { "MiniMapBaseArr", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 0, Z_Construct_UClass_AVVLF_MiniMapBase_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UMiniMapSubsystem_Statics::NewProp_OnMiniMapItemRegisteredSignature = { "OnMiniMapItemRegisteredSignature", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UMiniMapSubsystem, OnMiniMapItemRegisteredSignature), Z_Construct_UDelegateFunction_VVLF_MiniMap_MiniMapItemRegisteredSignature__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_UMiniMapSubsystem_Statics::NewProp_OnMiniMapItemRegisteredSignature_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMiniMapSubsystem_Statics::NewProp_OnMiniMapItemRegisteredSignature_MetaData)) }; // 1681360534
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UMiniMapSubsystem_Statics::NewProp_OnMiniMapItemUnregisteredSignature = { "OnMiniMapItemUnregisteredSignature", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UMiniMapSubsystem, OnMiniMapItemUnregisteredSignature), Z_Construct_UDelegateFunction_VVLF_MiniMap_MiniMapItemUnregisteredSignature__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_UMiniMapSubsystem_Statics::NewProp_OnMiniMapItemUnregisteredSignature_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMiniMapSubsystem_Statics::NewProp_OnMiniMapItemUnregisteredSignature_MetaData)) }; // 3309344935
	...
	template<> VVLF_MINIMAP_API UClass* StaticClass<UMiniMapSubsystem>()
	{
		return UMiniMapSubsystem::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UMiniMapSubsystem);
	UMiniMapSubsystem::~UMiniMapSubsystem() {}
	struct Z_CompiledInDeferFile_FID_ContentExamples_Plugins_UnrealSwissKnife_Source_VVLF_MiniMap_Public_MiniMapSubsystem_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ContentExamples_Plugins_UnrealSwissKnife_Source_VVLF_MiniMap_Public_MiniMapSubsystem_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMiniMapSubsystem, UMiniMapSubsystem::StaticClass, TEXT("UMiniMapSubsystem"), &Z_Registration_Info_UClass_UMiniMapSubsystem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMiniMapSubsystem), 3027685038U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ContentExamples_Plugins_UnrealSwissKnife_Source_VVLF_MiniMap_Public_MiniMapSubsystem_h_3768439135(TEXT("/Script/VVLF_MiniMap"),
		Z_CompiledInDeferFile_FID_ContentExamples_Plugins_UnrealSwissKnife_Source_VVLF_MiniMap_Public_MiniMapSubsystem_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_ContentExamples_Plugins_UnrealSwissKnife_Source_VVLF_MiniMap_Public_MiniMapSubsystem_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
